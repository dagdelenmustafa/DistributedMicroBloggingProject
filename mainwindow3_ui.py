...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget_2.setMaximumSize(QtCore.QSize(661, 411))
        self.tabWidget_2.setObjectName("tabWidget_2")
        self.login = QtWidgets.QWidget()
        self.login.setObjectName("login")
        self.label = QtWidgets.QLabel(self.login)
        self.label.setGeometry(QtCore.QRect(30, 60, 231, 16))
        self.label.setObjectName("label")
        self.label_20 = QtWidgets.QLabel(self.login)
        self.label_20.setGeometry(QtCore.QRect(30, 90, 231, 16))
        self.label_20.setObjectName("label_20")
        self.label_21 = QtWidgets.QLabel(self.login)
        self.label_21.setGeometry(QtCore.QRect(30, 120, 231, 16))
        self.label_21.setObjectName("label_21")
        self.label_22 = QtWidgets.QLabel(self.login)
        self.label_22.setGeometry(QtCore.QRect(30, 150, 231, 16))
        self.label_22.setObjectName("label_22")
        self.btn_login = QtWidgets.QPushButton(self.login)
        self.btn_login.setGeometry(QtCore.QRect(430, 180, 114, 32))
        self.btn_login.setObjectName("btn_login")
        self.et_my_ip = QtWidgets.QTextEdit(self.login)
        self.et_my_ip.setGeometry(QtCore.QRect(260, 60, 281, 21))
        self.et_my_ip.setObjectName("et_my_ip")
        self.et_my_port = QtWidgets.QTextEdit(self.login)
        self.et_my_port.setGeometry(QtCore.QRect(260, 90, 281, 21))
        self.et_my_port.setObjectName("et_my_port")
        self.et_peer_ip = QtWidgets.QTextEdit(self.login)
        self.et_peer_ip.setGeometry(QtCore.QRect(260, 120, 281, 21))
        self.et_peer_ip.setObjectName("et_peer_ip")
        self.et_peer_port = QtWidgets.QTextEdit(self.login)
        self.et_peer_port.setGeometry(QtCore.QRect(260, 150, 281, 21))
        self.et_peer_port.setObjectName("et_peer_port")
        ...
        self.btn_get_my_blog.setGeometry(QtCore.QRect(460, 310, 161, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Ip adresiniz:"))
        self.label_20.setText(_translate("MainWindow", "Port Numaranız"))
        self.label_21.setText(_translate("MainWindow", "Bağlanılacak Ip Adresi:"))
        self.label_22.setText(_translate("MainWindow", "Bağlanılacak Port Numarası:"))
        self.btn_login.setText(_translate("MainWindow", "Bağlan"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.login), _translate("MainWindow", "Login"))
        self.label_7.setText(_translate("MainWindow", "Takip Ettiklerim"))
